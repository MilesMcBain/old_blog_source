...
I thought I knew what this meant. I truly did. But it wasn't until I saw the conversation around [this tweet](https://twitter.com/nj_tierney/status/735087930251710464) from @[nj_tierney](https://twitter.com/nj_tierney) that I can honestly say the penny finally dropped. And boy did it drop. I'll say this real slow and clear like for old school coders like me:

**R has no primitive types.**

No seriously. Everything is an object. Integers and floats are always numeric vectors, even when then are 1 just one element long.  EVEN bloody boolean values which can be represented by a single bit in memory are objects. check this out:
